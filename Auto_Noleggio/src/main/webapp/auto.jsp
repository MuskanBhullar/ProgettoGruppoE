        ...
        <div id="container">
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/BMW X5.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    <h3>BMW X5</h3>
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 26,23€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div>
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Dacia Duster.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    <h3>Dacia Duster</h3>
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 19,88€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Fiat 500X.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    <h3>Fiat 500X</h3>
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 22,93€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Alfa Romeo Stelvio .jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    ...
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 32,53€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Mercedes Classe A.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    ...
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 37,20€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Mercedes-Benz GLE .jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    ...
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 35,00€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Opel Corsa.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    <h3>Opel Corsa</h3>
                    <p> Data di ritiro : <input type="date"> <br />
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Skoda Octavia.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    <h3>Skoda Octavia</h3>
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 24,55€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Volkswagen Golf.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    ...
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        Luogo di consegna : <select name="luogoconsegna" class="form-control">
                            ...
                            <b>Prezzo giornaliero: 30,00€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div>
            ...
            <div class="row gap100">
                <div class="col-md-6 col-lg-3">
                    <img src="image/Volkswagen Passat.jpg" class="img-fluid" alt="opel">
                </div>
                <div class="col-md-6">
                    ...
                    <p> Data di ritiro : <input type="date"> <br />
                        ...
                        <b>Prezzo giornaliero: 25,50€ </b><br>
                        <input type="submit" class="btn btn-primary" value="Aggiungi all'ordine" />
                    </p>
                </div>
            </div> 
