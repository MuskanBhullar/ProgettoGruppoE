                ...
                <div class="col-8 d-flex justify-content-center">
                    <div class="mb-3">
                        <form action="registrati" method="POST">
                            <input type="text" name="nomePersona" class="form-control" placeholder="Inserisci nome" /><br />
                            <input type="text" name="cognomePersona" class="form-control" placeholder="Inserisci cognome" /><br />
                            <input type="number" name="etaPersona" class="form-control" min="18" max="100" placeholder="Inserisci età" /><br />
                            <input type="text" name="emailPersona" class="form-control" placeholder="Inserisci email" /><br />
                            <input type="password" name="passwordPersona" maxlength="8" class="form-control" placeholder="Inserisci password" /><br />
