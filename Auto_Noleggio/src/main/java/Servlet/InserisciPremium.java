...
@WebServlet(name = "inseriscipremium", urlPatterns = {"/inseriscipremium"})
public class InserisciPremium extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet risultato = query.executeQuery("select * from auto where tipo = 'Premium' order by prezzo_giorn");
