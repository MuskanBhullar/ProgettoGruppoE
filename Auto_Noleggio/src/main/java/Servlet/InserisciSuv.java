...
@WebServlet(name = "inseriscisuv", urlPatterns = {"/inseriscisuv"})
public class InserisciSuv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet risultato = query.executeQuery("select * from auto where tipo = 'Suv' order by prezzo_giorn");
