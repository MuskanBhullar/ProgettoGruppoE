...
@WebServlet(name = "inseriscipiccola", urlPatterns = {"/inseriscipiccola"})
public class InserisciPiccola extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet risultato = query.executeQuery("select * from auto where tipo = 'Piccola' order by prezzo_giorn");
