...
@WebServlet(name = "inseriscimedia", urlPatterns = {"/inseriscimedia"})
public class InserisciMedia extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet risultato = query.executeQuery("select * from auto where tipo = 'Media' order by prezzo_giorn");
